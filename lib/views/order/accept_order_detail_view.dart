...
class AcceptOrderDetailView extends StatefulWidget {
  const AcceptOrderDetailView({super.key});

  @override
  State<AcceptOrderDetailView> createState() => _AcceptOrderDetailViewState();
}

class _AcceptOrderDetailViewState extends State<AcceptOrderDetailView> {
                      ...
                      children: [
                        Expanded(
                          ...
                          child: MaterialButton(
                            ...
                            elevation: 0,
                            child: const Icon(
                                size: 30.0, Icons.camera_alt_outlined),
                          ),
                        ),
                        Expanded(
                          flex: 3,
          ...
          actions: <Widget>[
            ...
            TextButton(
              onPressed: () {
                ...
                Navigator.pushNamed(context, RouteClass.tripCardDetail);
              },
              child: const Text(
                "Ok",
                style: TextStyle(color: BLACK_COLOR),
